...
extern int  perm[], sv[], cp[], actgen[], orb[], base[], lorb[], order[],
...
int gpprog(void)
{
  int i, j, k, l, m, n, nperms, nb, jobt, np2, seek, cord, ocord, given,
      ordknown, trivrel, lsv, u, v, w, x, y, z, mxp, mnb, bpt, bno, id;
  int   quot;
  float grporder;
