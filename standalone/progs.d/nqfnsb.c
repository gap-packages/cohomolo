...
extern int facexp, tails, stage, depth, no, mng, mexp, prime, exp, nng, class,
    dim, onng, *rpf, *rpb, *eexpnt, *enexpnt, **pcb, **opcb, **npcb, **npcb2,
    *nd1, *nd2, **extno, **subno, chpdim, chsdim, rel[], expnt[], nexpnt[],
    prvec[], pinv[], wt[], d1[], d2[], *pcptr[], **powptr[], **comptr[],
    *sspc[], *sspf[], sgen[], sex[], spgen[], spex[], spugen[], dpth[];
